  ...
  <view>
    <view class="addressItem" v-for="items in addressList" :key="items.index">
      ...
      <view class="addressBottom">
        ...
        <view class="addressBtn">
          <span @tap="toEditAddress(items.id)">
            <i class="tlwok-icon tlwicon-edit"></i>编辑
          </span>
          <span @tap="deteleAddress(items.id)">
            <i class="tlwok-icon tlwicon-delete"></i>删除
          </span>
        </view>
      </view>
    </view>
    <view class="btnCon">
      <view class="address" @tap="toEditAddress('')">
        <span>
          <i class="tlwok-icon tlwicon-add"></i>新建收货地址
        </span>
      </view>
    </view>
  </view>
